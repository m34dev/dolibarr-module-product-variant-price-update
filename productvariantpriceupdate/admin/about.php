...
/**
 * \file    productvariantpriceupdate/admin/about.php
 * \ingroup productvariantpriceupdate
 * \brief   About page of module ProductVariantPriceUpdate.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "productvariantpriceupdate@productvariantpriceupdate"));
...
llxHeader('', $langs->trans($title), $help_url, '', 0, 0, '', '', '', 'mod-productvariantpriceupdate page-admin_about');
